...
## Recent Check
- Re-checked on `2026-04-03` with expanded sources covering `arXiv`, `Springer`, `Nature`, `ScienceDirect`, and `Frontiers`.
- This pass surfaced several missing `2026` social-navigation papers and also synced a few already-in-README entries that had not yet been copied into this themed page.
- Within the previously watched 10-day window, [Enhanced Dynamic Window Approach for Socially Compliant Robot Navigation](https://www.frontiersin.org/journals/robotics-and-ai/articles/10.3389/frobt.2026.1769678/full) is now merged here with its exact online date `2026-03-24`.
